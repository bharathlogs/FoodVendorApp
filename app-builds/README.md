...
│   └── food-finder-v1.2.0-20260119.apk
├── v1.0.0/
...
**File:** [latest-release/food-finder-v1.2.0-20260119.apk](latest-release/)

See [v1.2.0/README.md](v1.2.0/README.md) for release notes.

## All Versions

| Version | Date | Release Notes |
|---------|------|---------------|
| [v1.2.0](v1.2.0/) | Jan 19, 2026 | Phone number & call, smooth marker animations, dark mode fixes |
...
```bash
adb install app-builds/latest-release/food-finder-v1.2.0-20260119.apk
```
